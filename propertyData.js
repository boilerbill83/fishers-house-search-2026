...
export const ALL_PROPERTIES = [
  {
    ...
    history: { daysOnMarket: 89, lastPriceChange: "2026-01-15", priceChanges: [], views: 0 },
  ...
  {
    // Verified 4/2/2026: Back to Active at $500K
    id: "prop_009",
    ...
    notes: "5 bedroom home with finished basement. Near Windermere golf course.",
    pros: [],
    cons: [],
    ...
    coordinateVerified: false,
    amenities: { parks: true, trails: true, shopping: false, restaurants: false, communityEvents: true },
    history: { daysOnMarket: 37, lastPriceChange: "2026-04-02", priceChanges: [], views: 0 },
    listingDate: "2025-10-15",
  },
  {
    // Verified 4/2/2026: Active $600K (price up from $578K)
    id: "prop_010",
    ...
    coordinateVerified: false,
    amenities: { parks: true, trails: true, shopping: true, restaurants: true, communityEvents: true },
    history: { daysOnMarket: 52, lastPriceChange: "2026-04-02", priceChanges: [], views: 0 },
    listingDate: "2025-10-15",
  },
  {
    // Verified 4/2/2026: Now Pending at $474,900 (confirmed via Zillow screenshot)
    id: "prop_012",
  ...
  {
    // Verified 4/2/2026: Confirmed Pending $600K
    id: "prop_014",
  ...
  {
    // Verified 4/2/2026: Active $495K (price dropped from $510K)
    id: "prop_016",
    ...
    coordinateVerified: false,
    amenities: { parks: true, trails: true, shopping: true, restaurants: false, communityEvents: false },
    history: { daysOnMarket: 1, lastPriceChange: "2026-04-02", priceChanges: [], views: 0 },
  ...
  {
    // Verified 4/2/2026: Active $640K — new listing 3/13/2026
    id: "prop_018",
  ...
  {
    // Verified 4/2/2026: Confirmed Pending $580K (AI checker was wrong — NOT Sold)
    id: "prop_020",
  ...
  {
    // Verified 4/2/2026: Confirmed Pending $575K
    id: "prop_022",
  ...
  {
    // Verified 4/2/2026: Confirmed Pending $535K
    id: "prop_023",
